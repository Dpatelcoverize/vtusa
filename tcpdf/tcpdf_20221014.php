...
class TCPDF {
	...
	public function Footer() {
		...
		if ($this->getRTL()) {
			...
			$footerhtml .= '<tr><td width="20%" style="text-align:left; ">TNG VT ARA v0622</td><td width="60%" style="text-align:center;">This is a copyright protected document. @ 2022</td><td width="20%" style="text-align:right;">Page '.$this->getAliasNumPage().'</td>';
			$footerhtml .= '</tr>';
			$footerhtml .= '</table>';
