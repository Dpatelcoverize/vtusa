...
//echo "Dlr_Mrkp_Actl_Amt=".$Dlr_Mrkp_Actl_Amt;
	...
	// Rewrite the PDF
	$pdfResult = createWarrantyPDF($link,$warrantyID,$isQuote);
                                    ...
                                    <form name="markupForm" id="markupForm" method="POST" action="">
											...
											<table border="1" cellpadding="5" cellspacing="5" class='alnright'>
												...
												<tr style="background-color:<?php echo $nextColor;?>">
													...
													<td style="text-align: center;"><?php echo $Veh_Type_Nbr;?></td>
													<td style="text-align: center;"><?php echo $Cntrct_Term_Mnths_Nbr; ?></td>
													<td style="text-align: left;"><?php echo $Cntrct_Lvl_Desc; ?></td>
													<td><?php echo "$".number_format($Dlr_Cost_Amt,0); ?></td>
