...
$directory_path = "/uploads/wearable_addendum_pdf";
...
$filename = "/" . str_replace(" ", "_", $customerName) . '_' . time() . '_addendum.pdf';
$pdfFileName = $directory . $filename;

$pdf = new GeneratePDF;
$uploaded_file = $pdf->generateAddendum($pdfData, $pdfFileName);
...
$stmt = mysqli_prepare($link, "INSERT INTO File_Assets(
                                ...
                                VALUES(?, ?, ?, ?, ?, ?, 'Wearable Addendum Asset', NOW())");

$path = $directory_path . $filename;

$fileType = $isQuote == 'Y' ? 24 : 23;
