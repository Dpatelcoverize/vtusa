...
//	  echo "<br /><br />Error: " . $sql . "<br>" . mysqli_error($link);
   ...
   'ADDRESS'=> $dealerAddress1 ,'PO BOX/SUITE' => $dealerAddress2 , 'CITY' => $dealerCity  , 'STATE/PROVINCE' => $dealerState  , 'ZIP/POSTAL CODE' => $dealerZip,
   ...
   'ACCOUNTS PAYABLE CONTACT EMAIL_1'=> $accountsPayableContactEmail ,'AP CONTACT PHONE_1'=> $accountsPayableContactPhone , 'MULTIPLE LOCATIONS?' => $multipleLocations_Long  , 'RETAILER SIGNATURE' => $fullFilename , 'RETAILER NAME'=> $retailerName  , 'RETAILER TITLE' => $retailerTitle ,
