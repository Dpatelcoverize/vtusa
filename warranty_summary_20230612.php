...
//echo "Dlr_Mrkp_Actl_Amt=".$Dlr_Mrkp_Actl_Amt;
	...
	//  the starting values
	$query = "SELECT Cntrct_Lvl_Desc,Cntrct_Term_Mnths_Nbr,Veh_Type_Nbr,c.Cntrct_Dim_ID FROM
...
//alert(pricingArr[2][1][5][1]);
												...
												<tr style="background-color:<?php echo $nextColor;?>">
													...
													if($Wrap_Flg=="Y"){
													?>
														<?php echo $Cntrct_Term_Mnths_Nbr;?>
														<input type="hidden" name="newTerm" value="<?php echo $Cntrct_Term_Mnths_Nbr;?>"/>
													<?php
													}else{
													?>
