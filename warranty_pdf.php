...
if ($dealerID != "" && $userType == "dealer") {
     /* get Pdf link */
    $queryString = "SELECT Path_to_File FROM File_Assets WHERE Acct_ID=" . $dealerID ." AND File_Asset_Type_ID = 7 ";
    $warantyPDF = $link->query($queryString);
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header text-center">
            <h4 class="card-title">Warranty PDF Files</h4>
          </div>
          <div class="card-body">
