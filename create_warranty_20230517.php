...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if ($phoneResult) {
		...
		if ($generatePdf) {
			...
			{
				//Generate Quote PDF
				createWarrantyPDF($link, $contract_ID , "Y");
			}
			else
			{
				//Generate Warranty PDF
				createWarrantyPDF($link, $contract_ID , "N");
			}
                                ...
                                <div class="basic-form dealer-form">
									...
									?>
                                            ...
                                            <div class="form-group col-md-6">
												...
												<?php
													// If not a primary contact, limit the selections in this dropdown.
													if($isContactPerson!="Y"){
												?>
														<p><?php echo $dealerUserFirstName . " " . $dealerUserLastName; ?></p>
												<?php
													}else{
