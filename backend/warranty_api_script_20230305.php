<?php
	 ...
	 $Warranty_PDF_SIGNED = ltrim($Warranty_PDF_SIGNED, '/');
//echo "Warranty_PDF=".$Warranty_PDF;
//die();
	 if (file_exists($Warranty_PDF_SIGNED)) {
	 	$b64WarrantyDoc = base64_encode(file_get_contents($Warranty_PDF_SIGNED));
		$Warranty_PDF = $Warranty_PDF_SIGNED;
	 }else if (file_exists($Warranty_PDF)) {
...
if($b64VIN_Image==""){
	echo "<br />b64VIN_Image blank";
	echo "<br />VIN_Photo=".$VIN_Photo;
	echo "<br />b64VIN_ImageName=".$b64VIN_ImageName;
	echo "<br /><br />";
}
if($b64Dashboard_Image==""){
	echo "<br />b64Dashboard_Image blank";
	echo "<br />Dashboard_Photo=".$Dashboard_Photo;
}else{
	echo "<br />Dashboard_Photo=".$Dashboard_Photo;
}
if($b64Engine_Image==""){
	echo "<br />b64Engine_Image blank";
}

echo "<br />";
echo "Engine_Photo=".$Engine_Photo;
echo "<br />";

echo "VIN_Photo=".$VIN_Photo;
echo "<br />";
echo "Dashboard_Photo=".$Dashboard_Photo;
echo "<br />";
echo "Engine_Photo=".$Engine_Photo;
echo "<br />";
//
...
//die();
	...
	echo "Warranty_PDF=".$Warranty_PDF;
	echo "<br />Maintenance_Form=".$Maintenance_Form;

	$command = "/home/dh_zzb8f9/portal.vitaltrendsusa.com/pdftk";
    $baseurl = "/home/dh_zzb8f9/portal.vitaltrendsusa.com/";
	$filename = "merged.pdf";
	$outputdir = "/home/dh_zzb8f9/portal.vitaltrendsusa.com/backend/".$filename;
