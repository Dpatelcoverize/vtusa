...
//Get Agent Info
$query = "SELECT * FROM Pers WHERE Pers_ID=" . $agentID;
$result = $link->query($query);
$dealerAgent = $result->fetch_assoc();

$dealerID = $dealerAgent["Acct_ID"];
...
$query = "SELECT * FROM Acct a, Usr_Loc u, Pers p, Email m, Tel t WHERE p.Pers_ID = ".$agentID." AND t.Pers_ID = p.Pers_ID AND m.Pers_ID = p.Pers_ID AND u.Pers_ID = p.Pers_ID AND a.Acct_ID = p.Acct_ID;"; 
...
$agentFirstName  = $row["Pers_Frst_Nm"];
$agentLastName   = $row["Pers_Last_Nm"];
$agentLocation  = $row["Acct_Nm"];
$agentEmail   = $row["Email_URL_Desc"];
$agentPhoneNumber  = $row["Tel_Nbr"];
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($result)
    {
        ...
        $body = "You have been signed up for a Vital Trends user account! Please click here to <a href='https://portaldev.vitaltrendsusa.com/login.php'>log in</a>. ";	
        $body .= "Your user name is: ".$agentEmail." Your initial password is: PASSWORD Please note, you will need to change your password upon first login.<br>";
        $body .= "<b>Thank you, Vital Trends</b>";
            
        $emailResult = sendEmail($agentEmail, "", "", $subject, $body);  
    }

    $_SESSION["success"] = "Signature added successfully. Please check your email and login to your Account.";

    // Redirect to next form
    header("location: dealerAgentSignature.php?agentID=".base64_encode($agentID));
    exit;
                    ...
                    unset($_SESSION['success']);
                        ...
                        <div class="card">
                            <div class="card-header text-center">
                                <h4 class="card-title">Capture Delaer Agent Signature</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <form name="dealerAgentForm" id="SignatureForm" method="POST" action="">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <h4 class="text-muted mb-0"><?php echo $agentFirstName   ?></h4>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <h5 class="text-primary d-inline">Last Name</h5>
                                                <h4 class="text-muted mb-0"><?php echo $agentLastName   ?></h4>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <h5 class="text-primary d-inline">Location</h5>
                                                <h4 class="text-muted mb-0"><?php echo $agentLocation ?></h4>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <h5 class="text-primary d-inline">Phone</h5>
                                                <h4 class="text-muted mb-0"><?php echo $agentPhoneNumber ?></h4>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <h5 class="text-primary d-inline">Email</h5>
                                                <h4 class="text-muted mb-0"><?php echo $agentEmail ?></h4>
                                            </div>
                                            <?php if($dealerAgent['w9_signature'] == ""){ ?>
                                            <div class="form-group col-md-12">
                                                <hr />
                                            </div>
                                        ...
                                        ?>
                                            <div class="form-group col-md-6">
                                                ...
                                                <img class="text-muted mb-0" src="uploads/<?php echo $dealerAgent['w9_signature']; ?>" alt="">
                                            </div>
