            ...
            <tr>
                ...
                <td style="width:40%;">
                    <p style="font-size:13px;text-align:center;">
                        <span style="text-align:center;margin-top:5%;font-size:22px;font-weight:bold;">Warranty Pricing Summary</span>
                    </p>
                </td>
            </tr>
        </table>
...
$query = "SELECT Pers_ID FROM Pers WHERE Acct_ID=" . $dealerID . " AND Cntct_Prsn_For_Acct_Flg='Y';";
