			...
			<div class="col-lg-12">
				<div class="form-group col-md-12">
					<a href="index.php" class="btn btn-sm btn-secondary">
                                           Done Adding Affiliates <i class="fa fa-angle-double-right"></i> Back To Main
                                        </a>
				</div>
			</div>
		</div>
...
--->
									...
									<input type="hidden" name="Affl_Fee_Amt" id="Affl_Fee_Amt" value="0" />
									<?php
									// Remove Affiliate fee form field, cparry 6/4
									if (false) {
									?>
										<div class="form-group col-md-6">
											<label>Affiliate Fee Percentage Amount</label>
											<input type="text" class="form-control Personal" name="Affl_Fee_Amt" id="Affl_Fee_Amt" placeholder="">
