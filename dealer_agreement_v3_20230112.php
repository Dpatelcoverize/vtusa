...
//	  echo "<br /><br />Error: " . $sql . "<br>" . mysqli_error($link);
   ...
   'ACCOUNTS PAYABLE CONTACT EMAIL_1'=> $accountsPayableContactEmail ,'AP CONTACT PHONE_1'=> $accountsPayableContactPhone , 'MULTIPLE LOCATIONS?' => $multipleLocations_Long  , 'RETAILER SIGNATURE' => $fileName , 'RETAILER NAME'=> $dealerName  , 'RETAILER TITLE' => $retailerTitle ,
