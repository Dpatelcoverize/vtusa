...
function createWarrantyPDF($link,$warrantyID,$isQuote, $isWrap="N"){
   ...
   //Lien
									...
									<tr>
										...
										<td width="350" align="left" class="padding-left">
											<table class="full-width" cellpadding="0" cellspacing="0">
												<tr>
													<td class="head-text-lg" align="center" style="font-size: 18px;">'.$title.'</td>
												</tr>
												<tr>
							...
							<td>
								<table class="inner-full-width" cellpadding="2" cellspacing="2" style="margin:0;">
									...
									<tr>
										...
										<td colspan="2" style="padding:7px 10px; font-size:13px;">$'.number_format($quantity*$MSRP_Amt,0).'</td>
										<td style="padding:7px 10px; font-size:13px;"></td>
										<td style="padding:7px 10px; font-size:13px;"></td>
									</tr>
									<tr>
										<td colspan="2" style="padding:7px 10px; font-size:13px;"><b>Add-Ons (Ex. APU, AEP, Aerial): </b></td>
										<td style="padding:7px 10px; font-size:13px;" colspan="4">$'.number_format($quantity*$Addl_MSRP_Amt,0).'</td>
									</tr>
									<tr>
										<td colspan="2" style="padding:7px 10px; font-size:13px;"><b>SMALL GOODS: </b></td>
										<td style="padding:7px 10px; font-size:13px;" colspan="4">$'.number_format($quantity*$Sml_Goods_Tot_Amt,0).'</td>
									</tr>
									<tr>
										<td colspan="2" style="padding:7px 10px; font-size:13px;"><b>TOTAL MSRP: </b></td>
										<td style="padding:7px 10px; font-size:13px;" colspan="4">$'.number_format($quantity*$Tot_MSRP_Amt,0).'</td>
									</tr>
								</table>
							</td>
						</tr>
	...
	else
	{
		...
		$pdf = new GeneratePDF;
		$pdf->generate($data , $pdfFileName , $Vehicle_Type , $isQuote, $isWrap);
