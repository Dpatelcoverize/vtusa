...
<!---
                <li class=" nav-item"><a href="index.php"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">Dashboard</span><span class="badge badge badge-primary badge-pill float-right mr-2">3</span></a>
...
--->
                <li class=" nav-item"><a href="index.php"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">Dashboard</span></a></li>
                <li class=" nav-item"><a href="authors.php"><i class="feather icon-users"></i><span class="menu-title" data-i18n="Authors">Authors</span></a></li>
                <li class=" nav-item"><a href="search_phrases.php"><i class="feather icon-layers"></i><span class="menu-title" data-i18n="Phrases">Search Phrases</span></a></li>
