                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
							...
							<?php if ($username != "") { ?>
								<strong>Dealer: </strong> <?php echo $dealerName; ?> (Hello <?php echo $dealerUserFirstName; ?>!) (<a href="dealer_logout.php">logout dealer</a>)
							<?php
		...
		?>
			...
			?>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
							<li><a href="../pending_agreements.php">Sales / Contracts</a></li>
							<li><a href="../pending_warranties.php">Finance</a></li>
							<li><a href="../pending_warranties.php">Claims</a></li>
							<li><a href="../pending_warranties.php">Contacts</a></li>
						</ul>
                    </li>
					<?php
