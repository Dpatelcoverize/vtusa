                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header text-center">
                                <h4 class="card-title">Supporting files for <?php if($isQuote=="Y"){echo " Quote ";}else{ echo " Warranty ";}?></h4>
                            </div>
							<?php
							...
							<?php } ?>
                                <a href="print_all_docs.php?warrantyID=<?php echo $warrantyID ?>&isQuote=<?php if($isQuote=="Y"){echo "Y";}else{ echo "N";}?>&salt=<?php echo $RandSaltString; ?>" class="btn btn-primary btn-md" target="_blank">Print Documents</a>
							</div>
							<?php
							if($errorMessage!=""){
							?>
									...
									<div class="form-row">
										...
										<div class="form-group col-md-6">
											<label>Inspection Report<span class="text-danger"></span>
												<a href="../uploads/fillable_documents/TNG EMV Inspection v0622 Fillable.pdf"
												  target="_blank">(download blank)</a>
											</label>
											<?php
												$fileTypeID = 8;
												$filePathResult = getFileAssetForWarranty($link,$warrantyID,$fileTypeID);
										...
										<div class="form-group col-md-6">
											<label>ECA Report<span class="text-danger"></span>
												<a href="../uploads/fillable_documents/EMV_TNG_VT_ECA_v0722_Fillable.pdf"
												  target="_blank">(download blank)</a>
											</label>
											<?php
												$fileTypeID = 9;
...
-->
										...
										<div class="form-group col-md-6">
											<label>Maintenance and Wear Form<span class="text-danger"></span>
												<a href="../uploads/fillable_documents/VT TNG EMV MWR v0622 F Fillable.pdf"
										...
										?>
											<div class="form-group col-md-6">
												<label>Fleet Maintenance Form<span class="text-danger"></span>
													<a href=""
													  target="_blank">EMV VT Fleet Maintenance Form (download)</a>
												</label>
												<br />
												<img style="height: 30px" src="images/pdf.png" alt="" />
											</div>
