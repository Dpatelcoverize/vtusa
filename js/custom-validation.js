...
*/
    ...
    if ($("#signatureFile")[0].files[0]) {
      var fileInput = $("#signatureFile")[0].files[0];
      var allowedTypes = ["image/jpeg", "image/png"];
      if (!allowedTypes.includes(fileInput.type)) {
        $("#signatureEType").css("display", "block");
        flag17 = 0;
      } else {
        $("#signatureEType").css("display", "none");
        flag17 = 1;
      }
    }
    ...
    if (
      ...
      $("#dealAgreementSubmit").prop("disabled", true);
      $("#dealAgreementSubmit").text("Dealer Loading......");
      form.submit();
    }
  });
});
...
*/
    ...
    if (flag1 == 1 && flag2 == 1 && flag3 == 1 && flag4 == 1) {
      ...
      let signatureBase30 = $(".signature").jSignature("getData", "base30");
      $(".base30").val(signatureBase30);
      $("#dealer_w9_submit").prop("disabled", true);
      $("#dealer_w9_submit").text("Dealer Loading......");
      form.submit();
    }
  });
});

//Submit dealer setup form
$(document).ready(function () {
  $("#dealer_setup_submit").click(function () {
    let form = $("#dealer_setup");
    $("#dealer_setup_submit").prop("disabled", true);
    $("#dealer_setup_submit").text("Dealer Loading......");
    form.submit();
  });
});

$(document).ready(function () {
  $("#dealer_manage_ar_submit").click(function () {
    var flag1 = 0;

    if ($("#arNumber").val() == "") {
      $("#ARNumberE").css("display", "block");
    } else {
      $("#ARNumberE").css("display", "none");
      flag1 = 1;
    }

    if (flag1 == 1) {
      //$("#dealer_w9_form").submit();
      let form = $("#dealer_manage_ar_form");
      $("#dealer_manage_ar_submit").prop("disabled", true);
      $("#dealer_manage_ar_submit").text("Dealer Loading......");
      form.submit();
    }
  });
  ...
  $("#pass_change_btn").click(function () {
    ...
    if ($("#cpassword").val() == "") {
      $("#cpasswordE").css("display", "block");
    } else {
      $("#cpasswordE").css("display", "none");
      flag2 = 1;
    }
    ...
    if (flag1 == 1 && flag2 == 1 && flag1 == 1) {
      //$("#dealer_w9_form").submit();
      let form = $("#pass_change");
      $("#pass_change_btn").prop("disabled", true);
      $("#pass_change_btn").text("Dealer Loading......");
      form.submit();
    }
  });
});
...
$(document).ready(function () {
  $("#dealer_addendum_submit").click(function () {
    ...
    if (flag1 == 1) {
      ...
      let signatureBase30 = $(".signature").jSignature("getData", "base30");
      $(".base30").val(signatureBase30);
      $("#dealer_addendum_submit").prop("disabled", true);
      $("#dealer_addendum_submit").text("Dealer Loading......");
      form.submit();
    }
  });
});
...
$(document).ready(function () {
  $("#dealBankingSubmit").click(function () {
    ...
    if (
      ...
      $("#dealBankingSubmit").prop("disabled", true);
      $("#dealBankingSubmit").text("Dealer Loading......");
...
$(document).ready(function () {
  $("#dealAffiliateSubmit").click(function () {
    ...
    if (
      ...
      $("#dealAffiliateSubmit").prop("disabled", true);
      $("#dealAffiliateSubmit").prop("Dealer Loading......");
